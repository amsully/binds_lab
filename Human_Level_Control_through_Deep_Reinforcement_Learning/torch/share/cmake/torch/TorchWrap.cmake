MACRO(ADD_TORCH_WRAP target luafile)
  ...
  ADD_CUSTOM_COMMAND(
    ...
    COMMAND /home/ubuntu/binds_lab/Human_Level_Control_through_Deep_Reinforcement_Learning/torch/bin/luajit ARGS "${CMAKE_CURRENT_SOURCE_DIR}/${luafile}" "${CMAKE_CURRENT_BINARY_DIR}/${cfile}"
